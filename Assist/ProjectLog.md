...
# ProjectLog #: 65
# Date: 2026-03-01
# Module: Tenant Blog Engine + Full-Text Search
# Type: Feature
# Summary:
Implemented a complete tenant-aware blog module across backend and frontend with tenant-scoped schema, soft-delete-aware CRUD, published filtering, idempotent seeding, advanced full-text search (PostgreSQL trigger/GIN index path), public blog pages, and basic admin CRUD UI.
Files Changed: Assist/API.md, Assist/DATABASE.md, Assist/STRUCTURE.md, Assist/ProjectLog.md, cxserver/Domain/BlogEngine/BlogCategory.cs, cxserver/Domain/BlogEngine/BlogTag.cs, cxserver/Domain/BlogEngine/BlogPost.cs, cxserver/Domain/BlogEngine/BlogPostTag.cs, cxserver/Domain/BlogEngine/BlogComment.cs, cxserver/Domain/BlogEngine/BlogLike.cs, cxserver/Domain/BlogEngine/BlogPostImage.cs, cxserver/Application/Abstractions/IBlogQueryService.cs, cxserver/Infrastructure/BlogEngine/BlogQueryService.cs, cxserver/Infrastructure/Persistence/Configurations/BlogCategoryConfiguration.cs, cxserver/Infrastructure/Persistence/Configurations/BlogTagConfiguration.cs, cxserver/Infrastructure/Persistence/Configurations/BlogPostConfiguration.cs, cxserver/Infrastructure/Persistence/Configurations/BlogPostTagConfiguration.cs, cxserver/Infrastructure/Persistence/Configurations/BlogCommentConfiguration.cs, cxserver/Infrastructure/Persistence/Configurations/BlogLikeConfiguration.cs, cxserver/Infrastructure/Persistence/Configurations/BlogPostImageConfiguration.cs, cxserver/Infrastructure/Persistence/TenantDbContext.cs, cxserver/Infrastructure/Migrations/Tenant/20260301050442_AddBlogModuleSchema.cs, cxserver/Infrastructure/Migrations/Tenant/20260301050442_AddBlogModuleSchema.Designer.cs, cxserver/Infrastructure/Migrations/Tenant/TenantDbContextModelSnapshot.cs, cxserver/Infrastructure/Seeding/TenantBlogSeeder.cs, cxserver/Infrastructure/Seeding/TenantDatabaseSeeder.cs, cxserver/Infrastructure/Onboarding/TenantSeederExecutor.cs, cxserver/Infrastructure/DependencyInjection/DependencyInjection.cs, cxserver/Endpoints/BlogEndpoints.cs, cxserver/Program.cs, cxweb/src/features/blog/types/blog-types.ts, cxweb/src/features/blog/services/blog-api.ts, cxweb/src/features/blog/hooks/useBlogPosts.ts, cxweb/src/features/blog/hooks/useBlogPost.ts, cxweb/src/features/blog/hooks/useBlogSearch.ts, cxweb/src/features/blog/components/BlogPostCard.tsx, cxweb/src/features/blog/components/CommentForm.tsx, cxweb/src/features/blog/components/LikeButton.tsx, cxweb/src/features/blog/components/ImageGallery.tsx, cxweb/src/features/blog/pages/BlogList.tsx, cxweb/src/features/blog/pages/BlogSearch.tsx, cxweb/src/features/blog/pages/BlogPost.tsx, cxweb/src/features/blog/pages/AdminBlogManager.tsx, cxweb/src/routes/router.tsx
