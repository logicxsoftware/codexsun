...
namespace cxserver.Infrastructure.Migrations.Tenant
{
    ...
    [Migration("20260301050442_AddBlogModuleSchema")]
    partial class AddBlogModuleSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_blog_categories_tenant_id");

                    b.HasIndex("TenantId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ux_blog_categories_tenant_name");

                    b.HasIndex("TenantId", "Slug")
                        .IsUnique()
                        .HasDatabaseName("ux_blog_categories_tenant_slug");

                    b.ToTable("blog_categories", (string)null);
                });

            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_blog_comments_tenant_id");

                    b.HasIndex("PostId", "Approved")
                        .HasDatabaseName("ix_blog_comments_post_approved");

                    b.ToTable("blog_comments", (string)null);
                });

            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogLike", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("char(36)")
                        .HasColumnName("post_id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_blog_likes_tenant_id");

                    b.ToTable("blog_likes", (string)null);
                });

            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId", "Slug")
                        .IsUnique()
                        .HasDatabaseName("ux_blog_posts_tenant_slug");

                    b.HasIndex("TenantId", "Published", "Active", "CreatedAtUtc")
                        .HasDatabaseName("ix_blog_posts_visibility");

                    b.ToTable("blog_posts", (string)null);
                });

            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogPostImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_blog_post_images_tenant_id");

                    b.HasIndex("PostId", "SortOrder")
                        .HasDatabaseName("ix_blog_post_images_post_sort");

                    b.ToTable("blog_post_images", (string)null);
                });

            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogPostTag", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("char(36)")
                        .HasColumnName("post_id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_blog_post_tags_tenant_id");

                    b.ToTable("blog_post_tags", (string)null);
                });

            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogTag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_blog_tags_tenant_id");

                    b.HasIndex("TenantId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ux_blog_tags_tenant_name");

                    b.HasIndex("TenantId", "Slug")
                        .IsUnique()
                        .HasDatabaseName("ux_blog_tags_tenant_slug");
            ...
            modelBuilder.Entity("cxserver.Domain.ProductCatalog.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("cxserver.Domain.ProductCatalog.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId", "IsActive", "CreatedAtUtc")
                        .HasDatabaseName("ix_products_tenant_active_created");

                    b.ToTable("products", (string)null);
                });

            modelBuilder.Entity("cxserver.Domain.ProductCatalog.ProductAttribute", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("cxserver.Domain.ProductCatalog.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogComment", b =>
                {
                    b.HasOne("cxserver.Domain.BlogEngine.BlogPost", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogPost", b =>
                {
                    b.HasOne("cxserver.Domain.BlogEngine.BlogCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("cxserver.Domain.BlogEngine.BlogPostTag", b =>
                {
                    ...
                    b.HasOne("cxserver.Domain.BlogEngine.BlogTag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("cxserver.Domain.ProductCatalog.Product", b =>
                {
                    b.HasOne("cxserver.Domain.ProductCatalog.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("cxserver.Domain.ProductCatalog.ProductAttribute", b =>
                {
                    b.HasOne("cxserver.Domain.ProductCatalog.Product", "Product")
                        .WithMany("Attributes")
