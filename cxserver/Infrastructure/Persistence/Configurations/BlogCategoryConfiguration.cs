...
internal sealed class BlogCategoryConfiguration : IEntityTypeConfiguration<BlogCategory>
{
    public void Configure(EntityTypeBuilder<BlogCategory> builder)
    {
        ...
        builder.HasIndex(x => x.TenantId).HasDatabaseName("ix_blog_categories_tenant_id");
        builder.HasIndex(x => new { x.TenantId, x.Name }).IsUnique().HasDatabaseName("ux_blog_categories_tenant_name");
        builder.HasIndex(x => new { x.TenantId, x.Slug }).IsUnique().HasDatabaseName("ux_blog_categories_tenant_slug");
    }
}
