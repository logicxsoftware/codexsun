    ...
    private static IReadOnlyList<PageSeedDefinition> BuildDefinitions()
    {
        ...
        [
            new PageSeedDefinition(
                ...
                "Home page",
                [
                    new SectionSeedDefinition(SectionType.Menu, "{\"items\":[{\"label\":\"Home\",\"href\":\"/\"},{\"label\":\"Shop\",\"href\":\"/products\"},{\"label\":\"About\",\"href\":\"/about\"},{\"label\":\"Contact\",\"href\":\"/contact\"}]}"),
                    ...
                    new SectionSeedDefinition(SectionType.BlogShow, "{\"limit\":3,\"title\":\"Latest From Our Blog\",\"subtitle\":\"Fresh tutorials, product insights, reviews, and IT tips from Codexsun.\",\"buttonText\":\"Explore Blog\",\"buttonHref\":\"/blog\"}"),
